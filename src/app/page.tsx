    ...
    <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-6">
      <div className="max-w-3xl text-center">
        <h1 className="text-4xl font-light tracking-tight mb-4">
          <span className="text-[#17ffdc]">Medline</span> Tool-Calling Agent
        </h1>
        <p className="text-lg text-[#888] mb-12 max-w-xl mx-auto">
          A hosted CRM plus an AI agent equipped with tools to search, create, update, delete,
          and report on CRM data — a demo of tool-powered chat interfaces.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-sm text-[#888]">
              A hosted CRM with credentialized API — the system the AI agent interacts with.
            </p>
          </Link>
